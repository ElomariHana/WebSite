...
$sql = 'SELECT titre,name,lienvideo FROM poste where name IN("ensa", "ensam", "inpt")';
...
<!-- End Header -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>ENSA && ENSAM && INPT</h2>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="assets/img/cc.PNG" class="img-fluid animated" alt="jj">
        </div>
      </div>
    </div>
  ...
  <div class="section-title">
      <h4> la correction  des epreuves anciens de concours d'accès ENSA && ENSAM && INPT</h4>
<div class="container">
