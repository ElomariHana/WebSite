...
$sql = 'SELECT titre,name,lienvideo FROM poste where name = "equationDrivvePartiell" ';
...
<!-- End Header -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>équations aux dérivées partielles linéaires</h1>
        </div>
  ...
  <div class="section-title">
      <h4>
      équations aux dérivées partielles linéaires</h4>
<div class="container">
